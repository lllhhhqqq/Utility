...
double table_cast_double( table_t table, size_t row, size_t col )
{
	return TABLE_CAST(table)->cast_double(row, col);
}
long long table_cast_int64( table_t table, size_t row, size_t col )
{
	return TABLE_CAST(table)->cast_int64(row, col);//
}
